...
public partial class GaymerLINQDataContext : System.Data.Linq.DataContext
{
  ...
  partial void InsertPermissionInContent(PermissionInContent instance);
  partial void UpdatePermissionInContent(PermissionInContent instance);
  partial void DeletePermissionInContent(PermissionInContent instance);
  ...
  partial void DeleteUserInfoType(UserInfoType instance);
	...
	public System.Data.Linq.Table<PermissionInContent> PermissionInContents
	{
		get
		{
			return this.GetTable<PermissionInContent>();
		}
	}
...
public partial class DynamicContentType : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<PermissionInContent> _PermissionInContents;
	...
	public DynamicContentType()
	{
		...
		this._PermissionInContents = new EntitySet<PermissionInContent>(new Action<PermissionInContent>(this.attach_PermissionInContents), new Action<PermissionInContent>(this.detach_PermissionInContents));
		OnCreated();
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DynamicContentType_PermissionInContent", Storage="_PermissionInContents", ThisKey="DynamicContentTypeId", OtherKey="ContentTypeId")]
	public EntitySet<PermissionInContent> PermissionInContents
	{
		get
		{
			return this._PermissionInContents;
		}
		set
		{
			this._PermissionInContents.Assign(value);
		}
	}
	...
	private void attach_PermissionInContents(PermissionInContent entity)
	{
		this.SendPropertyChanging();
		entity.DynamicContentType = this;
	}
	
	private void detach_PermissionInContents(PermissionInContent entity)
	{
		this.SendPropertyChanging();
		entity.DynamicContentType = null;
	}
...
public partial class Permission : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Permission_PermissionInContent", Storage="_PermissionInContent", ThisKey="PermissionId", OtherKey="PermissionId", IsUnique=true, IsForeignKey=false)]
	public PermissionInContent PermissionInContent
	{
		get
		{
			return this._PermissionInContent.Entity;
		}
		set
		{
			PermissionInContent previousValue = this._PermissionInContent.Entity;
			if (((previousValue != value) 
						|| (this._PermissionInContent.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._PermissionInContent.Entity = null;
					previousValue.Permission = null;
				}
				this._PermissionInContent.Entity = value;
				if ((value != null))
				{
					value.Permission = this;
				}
				this.SendPropertyChanged("PermissionInContent");
			}
		}
	}
...
[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PermissionInContent")]
public partial class PermissionInContent : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DynamicContentType_PermissionInContent", Storage="_DynamicContentType", ThisKey="ContentTypeId", OtherKey="DynamicContentTypeId", IsForeignKey=true)]
	public DynamicContentType DynamicContentType
	{
		get
		{
		...
		set
		{
						...
						|| (this._DynamicContentType.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					this._DynamicContentType.Entity = null;
					previousValue.PermissionInContents.Remove(this);
				}
				this._DynamicContentType.Entity = value;
				if ((value != null))
				{
					value.PermissionInContents.Add(this);
					this._ContentTypeId = value.DynamicContentTypeId;
				}
				else
				{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Permission_PermissionInContent", Storage="_Permission", ThisKey="PermissionId", OtherKey="PermissionId", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._Permission.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.PermissionInContent = null;
				}
				this._Permission.Entity = value;
				if ((value != null))
				{
					value.PermissionInContent = this;
